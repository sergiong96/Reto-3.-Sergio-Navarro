...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Productos destacados de CheapShop - Lista de productos en oferta">
    <meta name="keywords" content="oferta, producto, lista, tecnología, ecommerce, tienda online, promocion">
    ...
    <main id="heroFeatured">
        ...
        <section id="productList">
            <article class="product">
                ...
                <div class="promotion">¡Promoción!</div>
